...
<p class="testoc">
  ...
  quale migliore strada se non realizzare bellissime uova pasquali? Ecco che da
  un uovo pu&oacute;, come per magia, nascere un coniglio. Oppure per un regalo
  elegante, niente di meglio che un uovo di Faberg&eacute;. Vuoi dichiararti
...
<div align="center">
  <a href="mailto:sasy.vitrani@gmail.com"
    ><button class="uk-button uk-button-primary uk-button-large but"
      >Ordina un uovo pasquale</button
    ></a
  >
</div>
